...
const DashboardHero = () => {
  ...
  const [availableBalance, setAvailableBalance] = useState(() => {
    // Retrieve balance from local storage, if available
  ...
  useEffect(() => {
    ...
    const balance = totalEarningWithoutTax;
  ...
  return (
    <div className="w-full p-8">
      ...
      <div className="w-full block 800px:flex items-center justify-start">
        ...
        <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5 mx-4">
          <div className="flex items-center">
