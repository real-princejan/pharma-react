    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
            ...
            <div className="w-full flex items-start mb-5">
              ...
              <div className="w-full">
                ...
                <h5 className="pl-3 text-[20px] text-[#00000091]">
                  PHP {item.discountPrice} x {item.qty}
                </h5>
              </div>
              {!item.isReviewed && data?.status === "Delivered" ? (
                <div
                  className={`${styles.buttonR} text-[#fff]`}
      ...
      {open && (
        <div className="w-full fixed top-0 left-0 h-screen bg-[#0005] z-50 flex items-center justify-center">
          <div className="w-[50%] h-min bg-[#fff] shadow rounded-md p-3">
            ...
            <div className="w-full flex">
              ...
              <div>
                ...
                <h4 className="pl-3 text-[20px]">
                  PHP {selectedItem?.discountPrice} x {selectedItem?.qty}
                </h4>
              </div>
            </div>
            ...
            <div
              className={`${styles.buttonR} text-white text-[20px] ml-3`}
      ...
      <div className="border-t w-full text-right">
        <h5 className="pt-3 text-[18px]">
          Total Price: <strong>PHP {data?.totalPrice}</strong>
        </h5>
      </div>
      <br />
      <br />
      <div className="w-full 800px:flex items-center">
        ...
        <div className="w-full 800px:w-[40%]">
          ...
          {data?.status === "Delivered" && (
            <div
              className={`${styles.buttonX} text-white`}
      ...
      <br />
      <Link to="/inbox">
        <div className={`${styles.buttonR} text-white`}>Send Message</div>
      </Link>
      <br />
      <br />
    </div>
