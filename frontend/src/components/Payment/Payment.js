...
<div className="w-full bg-white rounded-md p-5 pb-8">
  ...
  <div>
    <div className="flex w-full pb-5 border-b mb-2">
      <h4 className="text-18 font-semibold text-black opacity-60">
        Cash on Delivery
      </h4>
    </div>
    ...
    <div className="w-full flex">
      <button
        ...
        className="bg-[#9F1515] text-white rounded-md py-3 px-6 font-semibold hover:shadow-xl transition duration-300"
      >
